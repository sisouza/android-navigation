...
//        setupActionBarWithNavController(navController, appBarConfig)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        //helper method. If the menu item is not meant to navigate handle with super.onOptionsItemSelected
...
//NavigationUI handle what happens when the Up button is pressed.
